...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "renders errors if input data is invalid" do
    ...
    assert_select ".text-error", text: I18n.t("activerecord.errors.models.user.attributes.password.too_short")
  end
  test "renders errors if passwords do not match" do
    ...
    assert_response :unprocessable_content
    assert_select ".text-error", text: I18n.t("activerecord.errors.models.user.attributes.password_confirmation.confirmation")
  end
end
